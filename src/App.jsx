        ...
        <section className='header__one'>
          <div className="container header__one__container">
            ...
            <div className="location">
              <img src={locationIcon} alt="locationIcon.svg" className="locationIcon" />
        ...
        <section className="hero">
          <div className="container hero__container">
            <div className="hero__left">
              ...
              <h1 className='hero__h1'>Liburan & nikmati <span>tempatbaru</span> di indonesia </h1>
              <p className='Destinize'>Destinize membuat kamu selalu update terkait tempat liburan baru di Indonesia dengan mengikuti perkembangan para influencer di sosial media ✨</p>
              <div>
